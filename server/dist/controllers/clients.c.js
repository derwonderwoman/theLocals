...
exports._register_client = exports._login_client = void 0;
var bcrypt_1 = __importDefault(require("bcrypt"));
var jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
var dotenv_1 = __importDefault(require("dotenv"));
var clients_js_1 = require("../models/clients.js");
var nanoid_1 = require("nanoid");
dotenv_1.default.config();
var _a = process.env, ACCESS_TOKEN_SECRET = _a.ACCESS_TOKEN_SECRET, ACCESS_TOKEN_EXPIRY = _a.ACCESS_TOKEN_EXPIRY;
var _login_client = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, client, isMatch, accessToken, decodedToken, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, email = _a.email, password = _a.password;
                return [4 /*yield*/, (0, clients_js_1.login)(email.toLowerCase())];
            case 1:
                client = _b.sent();
                if (!client) {
                ...
                isMatch = bcrypt_1.default.compareSync(password, client.password);
                if (!isMatch) {
                    res.status(404).json({ msg: "Wrong password" });
                    return [2 /*return*/];
                }
                accessToken = jsonwebtoken_1.default.sign({ id: client.id, email: client.email }, ACCESS_TOKEN_SECRET, {
                    expiresIn: ACCESS_TOKEN_EXPIRY
                });
                decodedToken = jsonwebtoken_1.default.verify(accessToken, ACCESS_TOKEN_SECRET);
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, clients_js_1.register)(newClientData)];
            case 2:
                newClient = _b.sent();
                newResponseClient = {
                    id: newID,
...
exports._register_client = _register_client;
